        ...
        <div className="mt-16 grid lg:grid-cols-3 gap-8">
          {sectors.map((sector, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group rounded-[2rem] border border-white/10 bg-white/[0.045] p-8 backdrop-blur-md hover:bg-white/[0.08] hover:-translate-y-2 transition duration-300"
            >
              ...
              <div className="mt-8 text-sm text-[#C8A95B] font-medium opacity-0 group-hover:opacity-100 transition duration-300">
